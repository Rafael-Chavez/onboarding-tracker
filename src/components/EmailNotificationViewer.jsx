...
export default function EmailNotificationViewer() {
  ...
  const sendTestEmail = useCallback(async () => {
    ...
    setTimeout(() => setStatusMessage(null), result.previewUrl ? 15000 : 5000);
    loadNotifications();
  }, [loadNotifications]);
          ...
          <div className="flex flex-col gap-1.5">
            ...
            {statusMessage.previewUrl && (
              <a
                ...
                className="text-cyan-100 hover:text-white underline text-xs font-semibold ml-6 block animate-pulse"
              >
                View Sent Email ↗
              </a>
            )}
