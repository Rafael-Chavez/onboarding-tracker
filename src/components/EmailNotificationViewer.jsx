          ...
          <div className="flex flex-col gap-1.5">
            ...
            {statusMessage.previewUrl && (
              <a
                ...
                className="text-white hover:text-blue-100 underline text-xs font-bold flex items-center gap-1 self-start mt-1"
              >
                🔗 Click here to View Sent Email (Ethereal)
              </a>
            )}
          </div>
        </div>
                    ...
                    <div className="flex items-center justify-between text-xs">
                      ...
                      {notification.previewUrl && (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-pink-400 hover:text-pink-300 underline font-semibold flex items-center gap-1"
                        >
                          🔗 View Sent Email
                        </a>
                      )}
