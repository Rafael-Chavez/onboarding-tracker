...
export default function EmailNotificationViewer() {
  ...
  const sendTestEmail = useCallback(async () => {
    ...
    setStatusMessage({
      ...
      previewUrl: result.success ? result.previewUrl || result.details?.previewUrl : null
    });
          ...
          <div className="flex flex-col gap-1">
            ...
            {statusMessage.previewUrl && (
              <a
                ...
                className="text-cyan-200 underline hover:text-cyan-100 text-xs mt-1 ml-6 inline-block font-bold"
              >
                View Sent Email ↗
              </a>
            )}
