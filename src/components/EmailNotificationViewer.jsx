          ...
          <div className="flex flex-col gap-1.5">
            ...
            {statusMessage.previewUrl && (
              <a
                ...
                className="text-white underline font-bold text-xs mt-1 block hover:text-blue-100 flex items-center gap-1 bg-black/20 px-2.5 py-1 rounded w-fit border border-white/10"
              >
                ✉️ View Sent Email (Ethereal Sandbox)
              </a>
            )}
          </div>
        </div>
