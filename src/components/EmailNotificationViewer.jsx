          ...
          <div className="flex flex-col gap-1.5">
            ...
            {statusMessage.previewUrl && (
              <a
                ...
                className="underline font-semibold hover:text-blue-100 text-xs block mt-1"
              >
                ...
                {notifications.map((notification, idx) => (
                  ...
                  >
                    ...
                    {notification.details && (
                      <div className="mt-2 text-[10px] text-white/50 bg-black/30 p-2 rounded font-mono border border-white/5">
                        <div className="font-bold mb-1 text-white/70">SMTP Diagnostics:</div>
