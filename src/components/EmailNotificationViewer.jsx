                  ...
                  >
                    ...
                    <div className="flex flex-col gap-2 mt-2 pt-2 border-t border-white/5">
                      ...
                      {notification.details && (
                        <div className="text-[10px] text-white/40 bg-black/40 rounded p-2 font-mono">
                          <div className="flex justify-between">
                            <span>SMTP Response:</span>
                            <span className="text-green-400/80">{notification.details.response}</span>
                          </div>
                          {notification.details.rejected?.length > 0 && (
                            <div className="flex justify-between text-red-400">
                              <span>Rejected:</span>
                              <span>{notification.details.rejected.join(', ')}</span>
                            </div>
                          )}
                        </div>
                      )}
