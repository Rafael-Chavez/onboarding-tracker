...
const OnboardingForm = ({
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      // Clear form only on success (check if result exists and succeeded)
      // The addOnboarding in OriginalApp returns result
  ...
  }, [addOnboarding, selectedEmployee, clientName, accountNumber]);
    ...
    <div className="backdrop-blur-md bg-white/10 rounded-2xl border border-white/20 p-6 shadow-2xl">
      ...
      <div className="space-y-4">
        ...
        <button
          ...
          disabled={isSubmitting || !selectedEmployee || !clientName.trim() || !accountNumber.trim()}
