...
function App({ onboardings: externalOnboardings, onUpdateOnboardings }) {
  ...
  const onboardings = useMemo(() => externalOnboardings || internalOnboardings, [externalOnboardings, internalOnboardings]);
